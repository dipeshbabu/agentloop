...
def analysis_to_html(payload: dict[str, Any], *, include_content: bool = False) -> str:
    ...
    sections = [
        ...
        '<nav aria-label="Report sections"><a href="#overview">Overview</a><a href="#timeline">Timeline</a><a href="#findings">Findings</a><a href="#comparison">Comparison</a><a href="#metadata">Metadata</a></nav></header>',
    ...
    sections.append(
        '</section><section id="metadata"><h2>Trace and research metadata</h2><p class="notice">Metadata may contain private text or identifiers. Review it before sharing this file.</p>'
